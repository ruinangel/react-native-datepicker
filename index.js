...
class DatePicker extends Component {
    ...
    getTitleElement() {
        ...
        if (!date && placeholder) {
            return (
                <HFText style={[Style.placeholderText, this.props.customStyles.placeholderText]} text={placeholder}/>);
        }
        return (<HFText style={[Style.dateText, this.props.customStyles.dateText]} text={this.getDateStr()}/>);
    }
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Animated.View
                                        style={[Style.datePickerCon, {height: HFConfiguration.pickerHeight+40}, customStyles.datePickerCon]}
                                    >
                                        <DatePickerIOS
                                            date={this.state.date}
                                        ...
                                        <TouchableOpacity
                                            underlayColor={'transparent'}
                                            style={[Style.btnText, Style.btnCancel, {width:HFConfiguration.windowWidth,backgroundColor:HFConfiguration.mainColor}, customStyles.btnCancel]}
                                        >
                                            <HFText fontSizeDiff={-1}
                                                    style={[Style.btnTextText, Style.btnTextCancel, {color:'white'}, customStyles.btnTextCancel]}
                                                    text='请选择时间'/>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            underlayColor={'transparent'}
                                            onPress={this.onPressCancel}
                                            style={[Style.btnText, Style.btnCancel, {backgroundColor:HFConfiguration.mainColor}, customStyles.btnCancel]}
                                        >
                                            <HFText fontSizeDiff={-1}
                                                    style={[Style.btnTextText, Style.btnTextCancel, {color:'white'}, customStyles.btnTextCancel]}
                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={[Style.btnText, Style.btnConfirm, {backgroundColor:HFConfiguration.mainColor}, customStyles.btnConfirm]}
                                        >
                                            <HFText fontSizeDiff={-1}
                                                    style={[Style.btnTextText, {color:'white'}, customStyles.btnTextConfirm]}
